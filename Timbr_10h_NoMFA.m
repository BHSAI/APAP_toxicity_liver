...
% % Bounds for metaboolites with no data (fixed based on the values in the original model Blais et al., Nat. Commun., (2017))
...
% find reaction names corresponding to reaction ids in s1
 for i = 1:length(s1)
