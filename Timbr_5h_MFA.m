...
% Under metabolic flux analysis constraints for short term exposure data (5h).
...
path_timbr_directory = [path_model_directory 'MFA_5h',filesep]; 
addpath (Fpath)
% Change the solver
...
StoredPath = [Fpath,'MFA_5h',filesep];
