...
% two different cases mentioned in the manuscript: "Timbr_10h_noMFA.m" and Timbr_10h_MFA.m"  
% These files use the timbr.m file 
% Output of these files are stored in Table format for each case MFA_10h and NoMFA_10h
% 4) Figure 7 is generated based on the stored timbr predicitons for each case and compared
...
% Mets_increased/decreased_10h_data)
...
%% list of increased/decreased metabolites from data for 10h exposure based on FDR <0.1 from Supplementary TableS4
In_Data10h=readtable('Mets_increased_10h_data.txt','Delimiter','\t');
De_Data10h=readtable('Mets_decreased_10h_data.txt','Delimiter','\t');
% Load the model results stored in MFA_10h folder for conditions under MFA
FilePath10 = [Fpath,'MFA_10h',filesep,'Table10h'];
load(FilePath10)
...
%% Load the model results stored in NoMFA_10h folder for conditions under NoMFA
nFilePath10 = [Fpath,'NoMFA_10h',filesep,'Table10h'];
load (nFilePath10)
